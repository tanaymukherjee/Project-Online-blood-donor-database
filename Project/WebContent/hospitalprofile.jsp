...
Blood has got no caste, so be human. Donate blood, help fellow humans.</marquee></font></b></font>
	...
	<INPUT type=text name="pemailid" readonly="readonly" VALUE="<%=h.getPemailid()%>" />
        ...
        <td><input type="text" name="semailid"  readonly="readonly"  VALUE="<%=h.getSemailid()%>"/>
        </td> 
                     </tr>
                     <tr>
                        <TD><b>Contact No</b></TD>
	<TD>
        <input type="text" name="contactno"  readonly="readonly"  VALUE="<%=h.getContactno()%>" />
        </TD> 
                     </tr>
                     <tr>
                        <TD><b>Hospital Web Site</b></TD>
	<TD>
        <input type="text" name="hwebsite" size="30"  readonly="readonly"  VALUE="<%=h.getHwebsite()%>"/>
      </TD> 
                     </tr>
                     <tr>
                       <TD><b>State</b></TD>
	...
	<input type="text" name="address" size="40" readonly="readonly"  VALUE="<%=h.getAddress()%>" />
                     ...
                     <a href="hospitalprofilemodify.jsp"><input type="submit" name="submit" id="submit" value="Modify" /></a>
                     </td></tr>
                 </table>
