...
Blood has got no caste, so be human. Donate blood, help fellow humans.</marquee></font></b></font>
         	...
         	<!-- directory -->
				...
				<div id="content">
                   ...
                   <font size="2.5">
                   <form action="supdatehistory.jsp" name="UPDATEHIS" method="post" onsubmit="return verify();">
                <br/><br/><br/><br/>
                <table>
                <tr><td>Date:</td>
                <td><input type="text" name="date" id="date"/><font color="grey">&nbsp;&nbsp;Eg.2012-3-31(yyyy-mm-dd)</font> </td></tr>
                <tr><td>Hospital Name:</td>
                <td><input type="text" name="hname" /></td></tr>
                <tr><td>Hospital Location</td>
                <td><input type="text" name="hlocation" /></td></tr>
                <tr><td>City</td>
