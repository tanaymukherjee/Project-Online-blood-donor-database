...
String sql="Select * from (SELECT complaintid,emailid,subject,complaint,date, ROW_NUMBER() OVER () AS RN FROM COMPLAINT) AS col where RN between "+rowStart+" and "+rowEnd+" order by RN desc" ;
rs=st.executeQuery(sql);
ResultSet rs1=st1.executeQuery("SELECT count( * ) as total_record FROM COMPLAINT");
rs1.next();
...
<tr> <td>DATE:</td><td  align="left"> <%=rs.getString(5)%><br /></td></tr>
<tr><td>EMAILID:</td> <td  align="left"><%=rs.getString(2)%><br /></td></tr>
<tr><td>SUBJECT:</td> <td  align="left"> <%=rs.getString(3)%><br /></td></tr>
<tr> <td>COMPLAINT ID:</td><td  align="left"> <%=rs.getString(1)%><br /></td></tr>


<tr> <td>COMPLAINT:</td><td  align="justify"> <%=rs.getString(4)%><br /><br /></td></tr>
...
<div class="pagination" align="center">
          ...
          <%
                ...
                {
          %>
           <a href="viewcomplaint.jsp?pageno=<%=previous%>">Prev</a>
       <%
}
        ...
        <%                 }
                                ...
                                {
        %>               
                                 <a href="viewcomplaint.jsp?pageno=<%=i%>"><%=i%></a>
       <%
                                }
                        }
                  }
     ...
     <%                 }
                            ...
                            {
     %>                             <a href="viewcomplaint.jsp?pageno=<%=next%>">Next</a>      
    <%
                             }
    %>
