...
<script type="text/javascript" language="javascript" src="lib/modifyprf.js"></script>
       <script language="JavaScript" src="lib/modifyprf.js"></script>
<%
...
Blood has got no caste, so be human. Donate blood, help fellow humans.</marquee></font></b></font>
         	...
         	<!-- directory -->
				...
				<div id="content">
                   ...
                   <form action="updatedonorprofile.jsp" name="UPDATEDONORPROFILE" method="POST" onsubmit="return check();">
	...
	<TD>
	<INPUT type=text name="mobileno"  VALUE="<%=d.getMobno()%>" />
	</TD> 
                     </tr>
                     <tr>
	...
	<TD>
	<INPUT type=text name="landlineno"  VALUE="<%=d.getLandlineno()%>" />
	</TD> 
                     </tr>
                     <tr>
                       <TD><b>State</b></TD>
	...
	<TD>  
        <input type="text" name="city"  readonly="readonly" VALUE="<%=d.getCity()%>" />
                     ...
                     <tr>
                         <TD><b>Pincode</b></TD>
	<TD>  
        <input type="text" name="pincode"   VALUE="<%=d.getPincode()%>" />
    </TD>
                     </tr>
                     <tr>
                         <TD><b>Permanent Address</b></TD>
	<TD>
	<input type="text" name="address" size="40"  VALUE="<%=d.getAddress()%>" />
