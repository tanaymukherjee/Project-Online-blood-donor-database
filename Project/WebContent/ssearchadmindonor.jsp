...
<script type="text/javascript" src="lib/statecity.js"></script>
    ...
    <body>
    	<div id="wrap">
                ...
                <div class="logo_text">
		<table>			
      <tr><td width="20%"><a href="adminrlogodescription.jsp"><img src="images/final logo.JPG" width="200" height="100" alt="final logo"/>
...
Blood has got no caste, so be human. Donate blood, help fellow humans.</marquee></font></b></font>
         	...
         	<!-- directory -->
				...
				<div id="content">
                    <table><tr><td></table><div class="contact_content_left" align="justify">
                     <h5><font color="lightgreen">Welcome to your Admin Profile</h5></font>
                        <br>
                        
                   <font size="2.5">
<form action="searchha1donor.jsp.jsp" method="post" name="SEARCH" onsubmit="return Valid1();">
...
%>
         ...
         <div class="pagination" align="center">
          ...
          <%
                ...
                {
          %>
           <a href="ssearchadmindonor.jsp?pageno=<%=previous%>">Prev</a>
       <%
}
        ...
        <%                 }
                                ...
                                {
        %>               
                                 <a href="ssearchadmindonor.jsp?pageno=<%=i%>"><%=i%></a>
       <%
                                }
                        }
                  }
     ...
     <%                 }
                            ...
                            {
     %>                             <a href="ssearchadmindonor.jsp?pageno=<%=next%>">Next</a>      
    <%
                             }
    %>
